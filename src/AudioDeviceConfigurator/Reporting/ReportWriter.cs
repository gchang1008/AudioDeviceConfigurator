...
public sealed class ReportWriter(IFileSystem fileSystem, string reportsDirectory)
{
    ...
    [
        ...
        "SourceSads", "WasapiResult", "WasapiHResult", "PlainWasapiResult", "PlainWasapiHResult",
        "ExtensibleWasapiResult", "ExtensibleWasapiHResult", "ApplyResult",
    ...
    private static IEnumerable<string> BuildRow(RunReport r, CandidateReport? c)
    {
        ...
        [
            ...
            c?.WasapiResult.ToString() ?? "", c?.WasapiHResult ?? "",
            c?.PlainWasapiResult.ToString() ?? "", c?.PlainWasapiHResult ?? "",
            c?.ExtensibleWasapiResult.ToString() ?? "", c?.ExtensibleWasapiHResult ?? "",
            c?.ApplyResult.ToString() ?? "",
